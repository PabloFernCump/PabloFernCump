...
Durante mis **prácticas (600 horas)**, me he especializado en el desarrollo web con **WordPress**, creando y programando páginas web desde cero.  
He trabajado especialmente con constructores visuales como **Elementor** y **Divi**, adquiriendo experiencia en diseño, personalización y optimización de sitios web.
...
- **DevOps / Despliegue:** Docker (docker-compose, entornos Node.js + base de datos)
  🐳 Experiencia creando entornos de desarrollo local dockerizados, levantando servicios con Node.js y bases de datos mediante docker-compose.
- **Entornos de desarrollo:** Visual Studio Code, IntelliJ IDEA, XAMPP  
- **Control de versiones:** Git y GitHub
- **Otros:** Fundamentos de IA aplicada al desarrollo  
...
- 🐳 DevOps:
  - Entorno dockerizado con **docker-compose** (Node.js + base de datos)
